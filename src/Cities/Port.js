...
export default function  Port({ navigation }) {
  return (
  <View style={styles.container}>
    <ImageBackground  source={require('../../assets/p3.jpg')} sizeMode="cover" style={styles.image}>

      <Text style={styles.textH}>Port Elizabeth</Text>
